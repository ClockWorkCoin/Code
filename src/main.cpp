...
uint256 hashGenesisBlock("0x000000009f9d4fe3fe0b2d7e0b66e3f8ebbb87250473d9137f4ac3ac34cc3a83");
...
const string strMessageMagic = "ClockWorkCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000009f9d4fe3fe0b2d7e0b66e3f8ebbb87250473d9137f4ac3ac34cc3a83");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1434099724;
        block.nBits    = 486604799;
        block.nNonce   = 668113379;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ClockWorkCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ClockWorkCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ClockWorkCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running ClockWorkCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ClockWorkCoinMiner terminated\n");
        throw;
    }
}
